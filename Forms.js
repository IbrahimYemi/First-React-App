  ...
  const render1 = (
    <div>
      <div className="formsubmit">
        ...
        <h3>
          My name is {data.firstName} {data.lastName} and i'm {data.age} years
          old
        </h3>
      ...
      {/* <div className="formsubmit">
        <p style={{ color: 'red', fontSize: '20px' }}>FOR SUBMIT</p>
        <h3>
          My name is {FirstName} {LastName} and i'm {Age} years old
        </h3>
        <h3>contact me on {Email}</h3>
        <h3>my feedback: {Feedback}</h3>
        <h3>
          I want {Swallow} with {Soup} soup mixed with good {Accessories},
          thanks
        </h3>
        <h3>
          {IsFoodtime ? 'Yes please remind me' : "No, thanks. I'm alright"}
        </h3>
      </div> */}
    </div>
  );
  ...
  return (
    <div>
      ...
      <div className="formsubmit">
        {data.isShowOutput
          ? render1
          : 'Please check the checkbox to display output'}
      </div>
    </div>
  );
}
